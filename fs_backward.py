...
print("Backward Elimination START")
run_with_k_fold_techniques(x_opt, y)
run_with_train_test_split_techniques(x_opt, y)
print("Backward Elimination FINISH")
